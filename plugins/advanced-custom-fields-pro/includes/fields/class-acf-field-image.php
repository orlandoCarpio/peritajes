...
<div <?php acf_esc_attr_e( $div ); ?>>
	<?php acf_hidden_input(array( 'name' => $field['name'],'class'=>"input-popup" ,'value' => $field['value'] )); ?>
	<div class="show-if-value image-wrap" <?php if( $size['width'] ): ?>style="<?php echo esc_attr('max-width: '.$size['width'].'px'); ?>"<?php endif; 
    	$urls=wp_get_attachment_image_src($field['value'],'large');
        $urlsf=($urls!='') ? $urls[0]:"#";
    	?>>
		<a class="popup-image-class"href="<?php echo esc_url($urlsf); ?>">
